...
function Banner() {
  return (
    <div className="md:mt-6 relative text-[20px] w-[90vw] max-w-[1360px] mx-auto rounded-lg flex justify-center items-center overflow-hidden bg-blue-400 flex-wrap">
